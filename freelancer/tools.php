...
<style>
.stat-box { background: rgba(255, 180, 0, 0.1); border-radius: 10px; padding: 1rem; text-align: center; }
.stat-value { font-size: 1.5rem; font-weight: bold; margin-bottom: 0.25rem; }
.stat-label { font-size: 0.875rem; color: var(--text-light); }
.list-group-dark .list-group-item { background: rgba(255, 180, 0, 0.05); border: 1px solid rgba(255, 180, 0, 0.1); color: var(--text-light); margin-bottom: 0.5rem; border-radius: 8px; }
.list-group-dark .list-group-item:hover { background: rgba(255, 180, 0, 0.1); }
</style>
