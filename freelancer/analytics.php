...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-6">
        <div class="card-premium">
            ...
            <div class="service-stat mb-3 p-3" style="background: rgba(255, 180, 0, 0.05); border-radius: 8px;">
...
<div class="card-premium">
    ...
    <div class="chart-placeholder" style="height: 300px; background: rgba(255, 180, 0, 0.05); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
...
<style>
.metric-card { background: rgba(255, 180, 0, 0.1); border-radius: 10px; padding: 1.5rem; text-align: center; }
