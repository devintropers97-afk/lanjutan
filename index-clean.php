<?php
/**
 * SITUNEO DIGITAL - Homepage (CLEAN VERSION)
 * No whitespace, no BOM, with output buffering
 */
ob_start();
require_once __DIR__ . '/includes/init.php';

$page_title = APP_NAME . " - " . APP_TAGLINE;
$page_description = "Solusi digital terlengkap untuk mengembangkan bisnis Anda. 26+ layanan profesional dengan harga terjangkau. Free demo website 24 jam!";
