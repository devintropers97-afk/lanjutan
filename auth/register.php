...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .benefit-item:hover { background: rgba(255, 180, 0, 0.2); transform: translateX(5px); }
        ...
        .btn-gold:hover { transform: translateY(-3px); box-shadow: 0 8px 25px rgba(255, 180, 0, 0.6); }
        ...
        .file-upload-label:hover { background: rgba(255, 180, 0, 0.1); border-color: var(--gold); }
            ...
            <div class="auth-right">
                ...
                <form method="POST" enctype="multipart/form-data" id="registerForm">
                    ...
                    <div class="freelancer-fields" id="freelancerFields">
                        <hr style="border-color: rgba(255, 180, 0, 0.2); margin: 20px 0;">
